...
public class VincentAI : AIArchetype {

    public override void SetUpAI()
    {
        myName = "Vincent";
        discription = "Trader, Smart";
        strategyType = "Expansion, Oriented towards harbors";

        myStrategy = new List<Strategy>() { Strategy.LongestRoad, Strategy.Revenue, Strategy.LargestArmy };
        startupResources = new List<float>() { .33f, .33f, .33f, 0, 0 };
